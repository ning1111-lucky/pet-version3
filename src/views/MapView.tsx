            ...
            <div className="relative group shadow-[2px_2px_0_var(--color-brown)]">
               <div className="bg-[var(--color-cream)] border-2 border-[var(--color-brown)] p-1 rounded-md hover:bg-[var(--color-caramel)] transition-colors">
                 <div className="w-8 h-8 rounded-sm bg-white flex items-center justify-center border border-[var(--color-brown)] overflow-hidden">
                    {entry.petImage ? (
                      <img src={entry.petImage} alt={entry.pet.name} className="w-full h-full object-cover" />
                    ) : (
        ...
        {selectedEntry && (
          ...
          >
             ...
             <div className="flex flex-col items-center">
                ...
                <div className="bg-white p-4 border-2 border-[var(--color-brown)] border-dashed rounded-xl mb-4 overflow-hidden relative group">
                   {selectedEntry.petImage ? (
                      <img src={selectedEntry.petImage} alt={selectedEntry.pet.name} className="w-32 h-32 object-cover rounded-md shadow-sm border border-gray-200" />
                   ) : (
